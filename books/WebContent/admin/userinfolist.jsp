...
<%
	...
	rs = stmt
			.executeQuery("select count(*) from userinfo where userid is not null "
					+ s_where);
	rs.next();
						...
						<div align="center">
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<tr>
									<td colspan="9">
										<div align="right">
											<a href="admin/userinfoadd.jsp">新建</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="admin/userinfosearch.jsp">查询</a>
										</div>
									</td>
								</tr>
								<tr>
								...
								<%
									rs = stmt
												.executeQuery("select * from userinfo where userid is not null "
														+ s_where + " order by userid ");
										...
										for (int i = 0; i < i_pagenum; i++) {
											...
											if (!rs.isLast()) {
												...
												String s_userid = (rs.getString("userid") != null ? rs
														.getString("userid") : "");
												String s_username = (rs.getString("username") != null ? rs
														.getString("username")
														: "");
												String s_gender = (rs.getString("gender") != null ? rs
														.getString("gender") : "");
												...
												String s_phone = (rs.getString("phone") != null ? rs
														.getString("phone") : "");
												String s_postcode = (rs.getString("postcode") != null ? rs
														.getString("postcode")
														: "");
												String s_state = (rs.getString("state") != null ? rs
														.getString("state") : "");
								...
								<tr>
									<td>
										<a href="admin/userinfoedit.jsp?op=show&userid=<%=s_userid%>"><%=s_userid%></a>
									</td>
									<td><%=s_username%></td>
									<td><%=s_gender%></td>
									<td><%=s_address%></td>
									...
									<td>
										<a
											href="admin/userinfodelete.jsp?op=delete&userid=<%=s_userid%>&currentpage=<%=i_currentpage%>">删除</a>
									</td>
									...
									<td colspan="9">
										<div align="center">
											...
											<%
												if (i_currentpage > 1) {
											%>
											<a href="admin/userinfolist.jsp?op=firstpage">首页</a>
											<%
												} else {
											%>首页<%
												}
											...
											%>
											<a
												href="admin/userinfolist.jsp?op=previous&currentpage=<%=i_currentpage%>">上一页</a>
											<%
												} else {
											%>上一页<%
												}
											...
											%>
											<a
												href="admin/userinfolist.jsp?op=next&currentpage=<%=i_currentpage%>">下一页</a>
											<%
												} else {
											%>下一页<%
												}
											...
											<%
												if (i_currentpage != i_totalpage) {
											%>
											<a href="admin/userinfolist.jsp?op=lastpage">末页</a>
											<%
												} else {
											%>末页<%
												}

...
<%
	...
	rs = stmt
			.executeQuery("select count(*) from employee where employeeid is not null "
					+ s_where);
	rs.next();
						...
						<div align="center">
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<tr>
									<td colspan="8">
										<div align="right">
											<a href="admin/employeeadd.jsp">新建</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="admin/employeesearch.jsp">查询</a>
										</div>
									</td>
								</tr>
								<tr>
								...
								<%
									rs = stmt
												.executeQuery("select * from employee where employeeid is not null "
														+ s_where + " order by employeeid ");
										...
										for (int i = 0; i < i_pagenum; i++) {
											...
											if (!rs.isLast()) {
												...
												String s_phone = (rs.getString("phone") != null ? rs
														.getString("phone") : "");
												String s_task = (rs.getString("task") != null ? rs
														.getString("task") : "");
								%>
								<tr>
									<td>
										<a
											href="admin/employeeedit.jsp?op=show&employeeid=<%=s_employeeid%>"><%=s_employeeid%></a>
									</td>
									<td><%=s_name%></td>
									<td><%=s_gender%></td>
									<td><%=s_address%></td>
									...
									<td>
										<a
											href="admin/employeedelete.jsp?op=delete&employeeid=<%=s_employeeid%>&currentpage=<%=i_currentpage%>">删除</a>
									</td>
									...
									<td colspan="8">
										<div align="center">
											...
											<%
												if (i_currentpage > 1) {
											%>
											<a href="admin/employeelist.jsp?op=firstpage">首页</a>
											<%
												} else {
											%>首页<%
												}
											...
											%>
											<a
												href="admin/employeelist.jsp?op=previous&currentpage=<%=i_currentpage%>">上一页</a>
											<%
												} else {
											%>上一页<%
												}
											...
											%>
											<a
												href="admin/employeelist.jsp?op=next&currentpage=<%=i_currentpage%>">下一页</a>
											<%
												} else {
											%>下一页<%
												}
											...
											<%
												if (i_currentpage != i_totalpage) {
											%>
											<a href="admin/employeelist.jsp?op=lastpage">末页</a>
											<%
												} else {
											%>末页<%
												}
